...
from Snowman3.utilities.objects.base_objects.properties import ObjectProperty, DataProperty



class Joint(Transform):

    hierarchy_children = ObjectProperty( name='hierarchy_children', default_value=[] )
