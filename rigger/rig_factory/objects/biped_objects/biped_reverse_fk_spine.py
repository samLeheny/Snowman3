...
from Snowman3.rigger.rig_factory.objects.rig_objects.grouped_handle import CogHandle
...
class BipedReverseFkSpine(Part):
    ...
    upper_ik_match_joint = ObjectProperty( name='upper_ik_match_joint' )
    lower_ik_match_joint = ObjectProperty( name='lower_ik_match_joint' )
    upper_fk_match_joint = ObjectProperty( name='upper_fk_match_joint' )
    hip_fk_match_joint = ObjectProperty( name='hip_fk_match_joint' )
    fk_match_transforms = ObjectListProperty( name='fk_match_transforms' )
    squash = DataProperty( name='squash', default_value=1.0 )
    rename_cog = DataProperty( name='rename_cog', default_value=True )
    lower_torso_handle = ObjectProperty( name='lower_torso_handle' )
    upper_torso_handle = ObjectProperty( name='upper_torso_handle' )
    center_handles = ObjectListProperty( name='center_handles' )
