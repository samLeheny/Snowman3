...
part_creators = [
    PartCreator(name='Root', prefab_key='root', side=None, position=[0, 0, 0],
                construction_inputs={}),
    PartCreator(name='Cog', prefab_key='cog', side=None, position=[0, 108, 0.39],
                construction_inputs={}),
    PartCreator(name='Spine', prefab_key='biped_spine', side='M', position=[0, 101, 0.39],
                construction_inputs={
                    'segment_count': 6
                }),
    PartCreator(name='Neck', prefab_key='biped_neck', side='M', position=[0, 150, 0.39],
                construction_inputs={}),
    ...
    PartCreator(name='Clavicle', prefab_key='biped_clavicle', side='R', position=[-3, 146.88, 0.39],
                construction_inputs={}),
    PartCreator(name='Arm', prefab_key='biped_arm', side='L', position=[15, 146.88, 0.39],
                construction_inputs={}),
    PartCreator(name='Arm', prefab_key='biped_arm', side='R', position=[-15, 146.88, 0.39],
                construction_inputs={}),
    ...
    PartCreator(name='Leg', prefab_key='leg_plantigrade', side='L', position=[8.5, 101, 0.39],
                construction_inputs={}),
    PartCreator(name='Leg', prefab_key='leg_plantigrade', side='R', position=[-8.5, 101, 0.39],
                construction_inputs={}),
]
